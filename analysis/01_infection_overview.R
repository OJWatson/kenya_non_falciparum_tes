...
df_summary_species_mixed$ymin <- vapply(as.numeric(df_summary_species_mixed$n), function(x) Hmisc::binconf(x,2027)[2], numeric(1))
df_summary_species_mixed$ymax <- vapply(as.numeric(df_summary_species_mixed$n), function(x) Hmisc::binconf(x,2027)[3], numeric(1))
